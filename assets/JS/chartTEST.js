...
// Store last top artist and track with date
// set new submission to local storage 

let topArtist = localStorage.getItem("topArtist");
let topTrack = localStorage.getItem("topTrack");
let topDate = localStorage.getItem("topDate");

const topEl = document.getElementById('top-history-stored');
topEl.innerHTML = "Previous Stats<br />Top Artist: " + topArtist + "<br />Top Track: " + topTrack + "<br />Date: " + topDate;

localStorage.setItem("topArtist", artistsName[0]);
localStorage.setItem("topTrack", tracksName[0]);
localStorage.setItem("topDate", today);
